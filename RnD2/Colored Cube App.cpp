...
void ColoredCubeApp::initBuildingPositions() {
	...
	if (level == 1) {
		...
		buildings[1].init(&brick, 2.0f, Vector3(420, 0, 1020),1,	95,		50,  95);//Left Side Building 2
		...
		buildings[4].init(&brick, 2.0f, Vector3(300, 0, 700),	1,	95,		70,  120);//Left Side Building 5
		...
		buildings[14].init(&brick, 2.0f, Vector3(-700, 0, 1350),1,	95,		50,  120);//Right Side Building 15
		buildings[15].init(&brick, 2.0f, Vector3(-300, 0, 1100),1,	110,	50,  130);//Right Side Building 16
		buildings[16].init(&brick, 2.0f, Vector3(-600, 0, 750),	1,	100,	50,  90);//Right Side Building 17
