...
void Quad::init(ID3D10Device* device, float scale, D3DXCOLOR c)
{
	...
	// Create vertex buffer
	 ...
	 Vertex vertices[] =
    {
		Vertex(D3DXVECTOR3(-1, 0, 0), D3DXVECTOR3(0, 1, 0), D3DXVECTOR2(0, 0), c, c), 
		Vertex(D3DXVECTOR3(1, 0, 0), D3DXVECTOR3(0, 1, 0), D3DXVECTOR2(1, 1), c, c), 
		Vertex(D3DXVECTOR3(0, 0, -1), D3DXVECTOR3(0, 1, 0), D3DXVECTOR2(1, 0), c, c), 
		Vertex(D3DXVECTOR3(0, 0, 1), D3DXVECTOR3(0, 1, 0), D3DXVECTOR2(0, 1), c, c)
    };
